...
function content_5f63901bc202c5_02735397 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <h2 class="text-primary"> Líderes
        <?php if (in_array('LIDE_A',$_smarty_tpl->tpl_vars['verificar']->value) == TRUE) {?>
          <a class="btn btn-sm btn-outline-primary mimodal" type="button" 
            href="lider_asignar.php?id=<?php echo $_smarty_tpl->tpl_vars['lider_seccion']->value['id'];?>
...
?>
            ...
            <td><?php echo $_smarty_tpl->tpl_vars['lider_seccion']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['nombre_equipo'];?>
</td>
            ...
            <?php if (in_array("PROF_AL",$_smarty_tpl->tpl_vars['verificar']->value) == TRUE) {?>
              <td>
                <?php if ($_smarty_tpl->tpl_vars['lider_seccion']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['id_persona'] == NULL) {?>
                  <a class="btn btn-sm btn-outline-primary" type="button" href="lider_asignar.php?id=<?php echo $_smarty_tpl->tpl_vars['lider_seccion']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['id'];?>
