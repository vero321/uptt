...
function content_600f614ea4fc01_50484684 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
					...
					<i class="card-img-top far fa-file-pdf fa-6x text-center m-1 p-2 text-danger"></i>
						...
						<div class="card-footer">
							<a class="btn btn-warning btn-sm btn-circle mimodal" data-href="../documentos/documento_agregar.php?t=<?php echo $_smarty_tpl->tpl_vars['trabajo']->value['id'];?>
&e=NULL" title="Subir correciones"><i class="fas fa-file-import mx-2 text-gray-900	"></i></a>
							<a data-href="../documentos/documento_ver.php?i=<?php echo $_smarty_tpl->tpl_vars['documentos']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['id_documento'];?>
...
?>
				...
				<div class="alert alert-danger">
					<div class="media">
						<i class="fas fa-info-circle fa-2x mr-3 my-3"></i>
						<div class="media-body my-2">
							<p class="notificaiton-title mb-2"><strong>Importante!</strong></p><p> Tines un trabjo para realizarle correcciones.</p>
