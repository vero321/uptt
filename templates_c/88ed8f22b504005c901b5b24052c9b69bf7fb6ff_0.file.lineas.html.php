...
function content_60049fb645f5c1_72104982 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <div class="card shadow">
          <div class="card-header d-flex justify-content-between">
            ...
            <?php if (in_array("LINE_A",$_smarty_tpl->tpl_vars['verificar']->value) == TRUE) {?>
             <a class="btn btn-sm btn-primary btn-circle mimodal" type="button"
            data-href="lineas_agregar.php" title="Agregar Línea de Investigación"><span class="fa fa-plus text-white"></span></a>
            <?php }?>
        </div>
        <div class="card-body">
