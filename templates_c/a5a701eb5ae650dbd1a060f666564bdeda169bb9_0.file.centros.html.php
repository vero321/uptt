...
function content_6008e2efc43a85_75198989 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <li class="breadcrumb-item active" aria-current="page"> Centros de Investigación</li>
        ...
        <div class="card">
          ...
          <div class="card-header d-flex justify-content-between">
            ...
            data-href="centros_agregar.php" title="Agregar Centro de Investigación"><span class="fa fa-plus text-white"></span></a>
            <?php }?>
          </div>
