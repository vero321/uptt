...
function content_5f89ee7d1bb278_71198514 (Smarty_Internal_Template $_smarty_tpl) {
?>
          ...
          name="nucleos_agregar">
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Nucleos</label>
                <select class="form-control" id="extencion" name="extencion">
