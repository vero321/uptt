...
function content_60076e947a13b5_60742546 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <!--dropdwn -->        
              ...
              <!--cotenido dropdwn -->        
                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                  ...
                  <a class="dropdown-item" href="propuesta_modificar.php?id=<?php echo $_smarty_tpl->tpl_vars['propuesta']->value['id'];?>
">
                    <i class="fa fa-edit fa-sm fa-fw mr-2 text-gray-800"></i>
                    Modificar
                  </a>
                  <a class="dropdown-item mimodal" data-href="propuesta_eliminar.php?id=<?php echo $_smarty_tpl->tpl_vars['propuesta']->value['id'];?>
">
...
" class="btn-link"><?php echo $_smarty_tpl->tpl_vars['comunidad']->value['url'];?>
</a>
                        <br>
                       <?php }?>
