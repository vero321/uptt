...
function content_60076e78e2b3a4_37340034 (Smarty_Internal_Template $_smarty_tpl) {
...
$__section_i_4_loop = (is_array(@$_loop=$_SESSION[$_prefixVariable2]) ? count($_loop) : max(0, (int) $_loop));
...
ob_start();
echo $_SESSION[$_prefixVariable3][(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['direccion'];
...
echo $_SESSION[$_prefixVariable5][(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['direccion'];?>
">
...
echo smarty_modifier_capitalize($_SESSION[$_prefixVariable7][(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['nombre']);?>
</span></a>
        </li>
        <?php } else { ?>
        <?php }?>
