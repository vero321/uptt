...
$miscampos  = array("id","correo","clave","id_tipo","id_rol");
...
if( isset( $_REQUEST['p'] ) ){
    $usuarios = bd_usuarios_datos3('id,correo,clave,id_tipo,id_rol' ,$_REQUEST['p'],$datos_por_pagina);


} else {
    $usuarios = bd_usuarios_datos2($i,$datos_por_pagina);
