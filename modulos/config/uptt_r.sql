...
-- Tiempo de generación: 27-10-2020 a las 09:07:26
...
(1, 'Proyecto 1', 2, 3, NULL, NULL, 25913031, 1),
(2, 'Proyecto 2', 1, 3, NULL, NULL, 25913031, 1),
(3, 'Proyecto 1', 3, 3, NULL, NULL, 25171058, 2),
(4, 'Poryecto 4', 1, 3, NULL, NULL, 25171058, 2),
...
CREATE TABLE `LOCALIDADES` (
  ...
  `tipo` enum('0','E','M','P') COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT '0',
  `id_pertenece` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `LOCALIDADES` (`id`, `descripcion`, `tipo`, `id_pertenece`) VALUES
(1, 'Venezuela', '0', 0),
(2, 'Miranda', 'E', 1),
(3, 'Trujillo', 'E', 1),
(4, 'Trujillo', 'M', 3),
...
(4, 'Núcleos Universitarios de Educación Socialista “Francisco de Miranda”', 'NUES Dividive', NULL, 0),
(7, 'Núcleos Universitarios de Educación Socialista “Barbarita De La Torre”', 'NUES Trujillo', 25171058, 0);
...
INSERT INTO `OBSERVACIONES` (`id`, `fecha`, `descripcion`, `tabla`, `campo`, `fila`) VALUES
(1, '2020-10-10 15:53:56', 'observacion 1', 'PROPUESTAS', 'propuesta', 3);
...
INSERT INTO `PERSONAS` (`id`, `nombre`, `apellido`, `foto_perfil`) VALUES
(25913031, 'María Verónica', 'Osuna Briceño', '25913031.jpg'),
(13896043, 'marisela', 'olmos de delgadillo', NULL),
(25171058, 'Jose', 'Palencia', '25171058.jpg'),
(25913050, 'karla patricia', 'quintero espinoza', '25913050.jpg'),
(9329308, 'arnoldo ', 'bric', NULL),
(25681838, 'Brando Aly', 'Hernandez Dúran', '25681838.jpg');
...
(126, 'PROP_V', 'Ver lista de las propuestas', '', 'Propuestas', 'fa fa-list-alt'),
...
CREATE TABLE `PROPUESTAS` (
  `id` int(11) NOT NULL,
  `propuesta` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `objetivo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_datos_propuestas` int(11) NOT NULL COMMENT 'Id del FPS-01',
  `status` enum('NUEVA','APROBADA','CORRECCIONES','DECLINADA','RECHAZADA') CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL DEFAULT 'NUEVA'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `PROPUESTAS` (`id`, `propuesta`, `objetivo`, `id_datos_propuestas`, `status`) VALUES
(1, '', '', 0, 'APROBADA'),
(2, 'prueba 1', 'prueba 1', 0, 'CORRECCIONES'),
(3, 'Sistema del Laboratorio', 'Dejar Operativo el Laboratorio', 15, 'NUEVA'),
(4, 'Mantenimiento a equipo', 'Instalar Software libre', 15, 'NUEVA'),
(5, 'Soporte a usuarios', 'talleres de capacitacion', 15, 'NUEVA'),
(6, 'p1', 'p1', 1, 'NUEVA'),
(7, 'p2', 'p2', 1, 'NUEVA'),
(8, 'p3', 'p3', 1, 'NUEVA');
...
--
-- Estructura de tabla para la tabla `PROPUESTAS_DATOS`
--

CREATE TABLE `PROPUESTAS_DATOS` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_pnf_nucleo` int(11) NOT NULL,
  `id_trayceto_pnf` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `id_docente` int(11) NOT NULL,
  `id_equipo` int(11) NOT NULL,
  `comunidad_objeto` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
  `id_parroquia` int(11) NOT NULL,
  `direccion` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `linea_investigacion` text COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `PROPUESTAS_DATOS`
--

INSERT INTO `PROPUESTAS_DATOS` (`id`, `id_pnf_nucleo`, `id_trayceto_pnf`, `fecha`, `id_docente`, `id_equipo`, `comunidad_objeto`, `id_parroquia`, `direccion`, `linea_investigacion`) VALUES
(1, 1, 1, '2020-10-26', 13896043, 1, 'consoje comunal', 300, 'la puerta', 'lo que sea'),
(2, 1, 1, '0000-00-00', 13896043, 1, 'Prueba', 1257, 'Prueba', '');
...
INSERT INTO `TRABAJOS` (`id`, `fecha_mes`, `fecha_anyo`, `observacion`, `responsable`, `status`) VALUES
(1, 'ENERO', 2020, 'repositorio uptt', 'veronica osuna', 'APROBADO'),
(2, 'SEPTIEMBRE', 2018, 'mmmmmmmmmmmmmmmnnnnnnnnnnn.........', 'karla quintero', 'CORRECCIONES');
...
(157, 12345678, '5e7ec3342d4ee', NULL, NULL, 0),
...
(297, 25171058, '5f31934b35e04', 7, 3, NULL),
(298, 25171058, '5f247c7e111a3', 7, 3, NULL),
...
(305, 25171058, '5f247c7e111a3', 1, 1, NULL),
(306, 9329308, '5f247c7e111a3', 1, 1, NULL),
(307, 9329308, '5f247c7e111a3', 1, 1, NULL),
...
--
-- Indices de la tabla `PROPUESTAS_DATOS`
--
ALTER TABLE `PROPUESTAS_DATOS`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `OBSERVACIONES`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Tabla para las observaciones, segun las correcciones que requiera asi sea la propuesta, el trabajo o el documento, con el fin de llevar un reporte de cada observacion y que los docentes lleven un seguimiento de eso', AUTO_INCREMENT=2;
--
...
ALTER TABLE `PROPUESTAS`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `PROPUESTAS_DATOS`
--
ALTER TABLE `PROPUESTAS_DATOS`
